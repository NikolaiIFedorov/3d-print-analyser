...
- **Idle status text:** Simplified to `N solid(s), M rendered vertices` (solids from scene; rendered = last-uploaded triangle + line VBO vertex counts from `SceneRenderer` getters).
