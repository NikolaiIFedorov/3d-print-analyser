...
/// Calibrate: non-selectable faces (second pick) get this subtle veil everywhere; reject-hover draws on top.
inline constexpr float kPickHighlightCalibInvalidPoolAlpha = 0.13f;
